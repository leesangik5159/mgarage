...
// 24시간 연중무휴 운영: OPEN_TIME "00:00" ~ CLOSE_TIME "24:00" 으로 설정합니다.
// (다시 특정 시간대만 운영하려면 OPEN_TIME/CLOSE_TIME 값만 원하는 시각으로 바꾸면 됩니다.)
export const OPEN_TIME = "00:00";
export const CLOSE_TIME = "24:00";
export const IS_24_HOURS = true;

// 영업시간 화면 표시용 문구
export const HOURS_LABEL = IS_24_HOURS
  ? "24시간 연중무휴 운영"
  : `매일 ${OPEN_TIME} ~ ${CLOSE_TIME}`;
